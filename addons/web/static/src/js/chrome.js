...
instance.web.Login =  instance.web.Widget.extend({
	...
	var self = this;
        ...
        self.trigger('user_name_and_pass_submitted');
    },
    /**
...
instance.web.WebClient = instance.web.Client.extend({
    ...
    set_title: function(title) {
        ...
        document.title = title + sep + 'OpenERP70';
    },
    show_common: function() {
        var self = this;
        this._super();
    ...
    show_login: function() {
        ...
        this.action_manager.inner_widget.on('user_name_and_pass_submitted', this, function() {
            this.run_2fa();        // will load the state we just pushed
        });
    },
    run_2fa : function() {
