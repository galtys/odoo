...
sale_shop()
so_exceptions=['SO2022', 'SO2102', 'SO2102', 'SO2391', 'SO3088', 'SO4273', 'SO3457', 'SO3280', 'SO2771', 'SO3093', 'SO3091', 'SO3087', 'SO3089', 'SO3502', 'SO3502', 'SO4275', 'SO3688', 'SO4414', 'SO4970', 'SO4970', 'SO4970', 'SO4970', 'SO3691', 'SO3691', 'SO5878', 'SO5878', 'SO3092', 'SO5886', 'SO5886', 'SO5038', 'SO5038', 'SO5038', 'SO5038', 'SO5038', 'SO5038', 'SO5038', 'SO5038','SO5303']
    ...
    def _pjb_check_partner_pricelist(self, cr, uid, ids, context=None):
        for so in self.browse(cr, uid, ids):
            if (so.pricelist_id.id != so.partner_id.property_product_pricelist.id) and (so.pricelist_id.type not in ('retail')):
                return False
        return True
    def _get_tax_codes(self, cr, uid, ids):
            codes=[]
            for so in self.browse(cr, uid, ids):
                for l in so.order_line:
                    for t in l.tax_id:
                        if t.id not in codes:
                            codes.append(t.id)
            return codes
